...
pub fn app() -> Html {
  ...
  html! {
    <nav class="flex items-center h-12 mx-2 mb-4">
      ...
      <Link<Routes> to={Routes::About}>
        <button class={classes!("nav-item", "hidden", "ss:block", util::util::either!(page_val == "About" => "active-nav-item"; ""))} id="About" onclick={onclick_nav.clone()}>
          {"About"}
        </button>
      </Link<Routes>>

      <Link<Routes> to={Routes::Projects{project: "~".to_string()}}>
        <button class={classes!("nav-item", "hidden", "ss:block", util::util::either!(page_val == "Projects" => "active-nav-item"; ""))} id="Projects" onclick={onclick_nav.clone()}>
          {"Projects"}
        </button>
      </Link<Routes>>

      <Link<Routes> to={Routes::Contact}>
        <button class={classes!("nav-item", "mr-10", "hidden", "ss:block", util::util::either!(page_val == "Contact" => "active-nav-item"; ""))} id="Contact" onclick={onclick_nav}>
          {"Contact"}
        </button>
      </Link<Routes>>
    </nav>
